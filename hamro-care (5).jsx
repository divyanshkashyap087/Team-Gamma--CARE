...
const T = {
  en: {
    ...
    currentMeds: "Current Medications (Optional)", submit: "Continue",
    ...
    patientRecords: "Patient Reports", docCommunity: "Doctor Community",
    docPatientComm: "Patient Connect",
    ...
    emergencyContacts: "Emergency Contacts", generateReport: "Generate & Send Report to Doctors",
    reportSent: "Report sent to all available doctors!", chatWith: "Chat with",
    ...
    sentToDoc: "This report has been sent to all available doctors.",
    ...
    aiConversations: "AI Conversations", reportsGenerated: "Reports Sent",
    connectedDoctors: "Online Doctors", healthScore: "Health Score",
    physicalConditions: "Physical Conditions (Optional)",
    patientConnect: "Patient Connect",
    noPatientReports: "No patient reports yet. When patients send AI-generated reports, they appear here.",
    connectPatient: "Connect with Patient",
    urgencyHigh: "High Priority", urgencyMed: "Medium", urgencyLow: "Low",
    mapTitle: "Live Map — Nearby Facilities",
    locating: "Locating you...", locError: "Could not get location. Showing Kathmandu.",
    getDirections: "Get Directions",
    reportedAt: "Reported at",
    sendReportBtn: "Send Report to Doctors",
    reportAlreadySent: "Report already sent to doctors",
  },
  ne: {
    ...
    currentMeds: "हालको औषधि (वैकल्पिक)", submit: "जारी राख्नुहोस्",
    ...
    patientRecords: "बिरामी रिपोर्ट", docCommunity: "डाक्टर समुदाय",
    docPatientComm: "बिरामी जडान",
    ...
    emergencyContacts: "आपतकालीन सम्पर्क", generateReport: "रिपोर्ट बनाउनुहोस् र डाक्टरलाई पठाउनुहोस्",
    reportSent: "रिपोर्ट सबै डाक्टरहरूलाई पठाइयो!", chatWith: "सँग च्याट",
    ...
    disclaimer: "AI सुझावहरू पेशेवर चिकित्सा सल्लाहको विकल्प होइनन्।",
    loading: "लक्षणहरू विश्लेषण गर्दै...", reportTitle: "AI मेडिकल रिपोर्ट",
    sentToDoc: "यो रिपोर्ट सबै उपलब्ध डाक्टरहरूलाई पठाइएको छ।",
    ...
    aiConversations: "AI कुराकानी", reportsGenerated: "पठाइएका रिपोर्ट",
    connectedDoctors: "अनलाइन डाक्टर", healthScore: "स्वास्थ्य स्कोर",
    physicalConditions: "शारीरिक अवस्थाहरू (वैकल्पिक)",
    patientConnect: "बिरामी जडान",
    noPatientReports: "अहिलेसम्म कुनै बिरामी रिपोर्ट छैन।",
    connectPatient: "बिरामीसँग जडान",
    urgencyHigh: "उच्च प्राथमिकता", urgencyMed: "मध्यम", urgencyLow: "न्यून",
    mapTitle: "लाइभ नक्सा — नजिकका सुविधाहरू",
    locating: "स्थान खोज्दै...", locError: "स्थान पाउन सकिएन। काठमाडौं देखाउँदै।",
    getDirections: "दिशा लिनुहोस्",
    reportedAt: "रिपोर्ट गरिएको",
    sendReportBtn: "डाक्टरलाई रिपोर्ट पठाउनुहोस्",
    reportAlreadySent: "रिपोर्ट पहिले नै पठाइएको छ",
  },
  ma: {
    ...
    currentMeds: "वर्तमान दवाई (वैकल्पिक)", submit: "जारी रखू",
    ...
    specialization: "विशेषज्ञता", hospital: "अस्पताल / क्लिनिक",
    patientRecords: "रोगी रिपोर्ट", docCommunity: "डॉक्टर समुदाय",
    docPatientComm: "रोगी जुड़ाव",
    male: "पुरुष", female: "महिला", other: "अन्य",
    alreadyHaveAccount: "पहिने खाता अछि?", loginHere: "एतय लॉगिन करू",
    noAccount: "खाता नहि अछि?", registerHere: "एतय पंजीकरण करू",
    emergencyContacts: "आपातकालीन संपर्क", generateReport: "रिपोर्ट बनाउ आ डॉक्टर केँ पठाउ",
    reportSent: "रिपोर्ट सभ डॉक्टर लोकनिकेँ पठाओल गेल!", chatWith: "संग चैट",
    ...
    disclaimer: "AI सुझाव पेशेवर चिकित्सा सलाहक विकल्प नहि थिक।",
    loading: "लक्षण विश्लेषण करैत...", reportTitle: "AI मेडिकल रिपोर्ट",
    sentToDoc: "ई रिपोर्ट सभ उपलब्ध डॉक्टर लोकनि केँ पठाओल गेल।",
    callAmbulance: "एम्बुलेंस बजाइत अछि...",
    required: "कृपया सबटा आवश्यक फील्ड भरू।",
    licenseVerified: "लाइसेंस सत्यापित", verifying: "सत्यापित करैत...",
    ...
    aiConversations: "AI वार्तालाप", reportsGenerated: "पठाओल रिपोर्ट",
    connectedDoctors: "अनलाइन डॉक्टर", healthScore: "स्वास्थ्य स्कोर",
    physicalConditions: "शारीरिक स्थिति (वैकल्पिक)",
    patientConnect: "रोगी जुड़ाव", noPatientReports: "अखन धरि कोनो रोगी रिपोर्ट नहि।",
    connectPatient: "रोगीसँ जुड़ू", urgencyHigh: "उच्च प्राथमिकता", urgencyMed: "मध्यम", urgencyLow: "न्यून",
    mapTitle: "लाइव नक्शा — नजदीकी सुविधा", locating: "स्थान खोजैत...", locError: "स्थान नहि भेटल। काठमाण्डु देखाइत।",
    getDirections: "दिशा लिअ", reportedAt: "रिपोर्ट कएल",
    sendReportBtn: "डॉक्टर केँ रिपोर्ट पठाउ", reportAlreadySent: "रिपोर्ट पहिने पठाओल गेल",
  },
  bh: {
    ...
    currentMeds: "अभी के दवाई (वैकल्पिक)", submit: "जारी रखीं",
    ...
    docLicense: "डॉक्टर लाइसेंस नंबर", docCertificate: "डॉक्टर सर्टिफिकेट अपलोड",
    specialization: "विशेषज्ञता", hospital: "अस्पताल / क्लिनिक",
    patientRecords: "मरीज रिपोर्ट", docCommunity: "डॉक्टर समुदाय",
    docPatientComm: "मरीज कनेक्ट",
    male: "पुरुष", female: "महिला", other: "अन्य",
    alreadyHaveAccount: "पहिले से खाता बा?", loginHere: "इहाँ लॉगिन करीं",
    noAccount: "खाता नइखे?", registerHere: "इहाँ पंजीकरण करीं",
    emergencyContacts: "आपातकालीन संपर्क", generateReport: "रिपोर्ट बनाईं आ डॉक्टरन के भेजीं",
    reportSent: "रिपोर्ट सब डॉक्टरन के भेजाइल!", chatWith: "से चैट",
    videoCall: "वीडियो कॉल", audioCall: "ऑडियो कॉल", chat: "चैट",
    ...
    disclaimer: "AI सुझाव पेशेवर चिकित्सा सलाह के विकल्प नइखे।",
    loading: "लच्छन विश्लेषण होत बा...", reportTitle: "AI मेडिकल रिपोर्ट",
    sentToDoc: "ई रिपोर्ट सब उपलब्ध डॉक्टरन के भेजाइल गइल बा।",
    callAmbulance: "एम्बुलेंस बुलात बानी...",
    required: "कृपया सब जरूरी खाना भरीं।",
    licenseVerified: "लाइसेंस सत्यापित", verifying: "सत्यापित होत बा...",
    nearby: "नजदीकी चिकित्सा सुविधा", km: "किमी दूर", open24: "२४/७ खुला",
    ...
    aiConversations: "AI बातचीत", reportsGenerated: "भेजल रिपोर्ट",
    connectedDoctors: "ऑनलाइन डॉक्टर", healthScore: "स्वास्थ्य स्कोर",
    physicalConditions: "शारीरिक स्थिति (वैकल्पिक)",
    patientConnect: "मरीज कनेक्ट", noPatientReports: "अभी कवनो मरीज रिपोर्ट नइखे।",
    connectPatient: "मरीज से जुड़ीं", urgencyHigh: "उच्च प्राथमिकता", urgencyMed: "मध्यम", urgencyLow: "कम",
    mapTitle: "लाइव नक्शा — नजदीकी सुविधा", locating: "स्थान खोजत बा...", locError: "स्थान ना मिलल। काठमाण्डु देखावत बा।",
    getDirections: "दिशा लीं", reportedAt: "रिपोर्ट कइल",
    sendReportBtn: "डॉक्टरन के रिपोर्ट भेजीं", reportAlreadySent: "रिपोर्ट पहिलेही भेजाइल बा",
  },
};

const mockFacilities = [
  { name: "Bir Hospital", type: "hospital", dist: "0.8", open24: true, phone: "01-4221988", lat: 27.7068, lng: 85.3134 },
  { name: "Tribhuvan University Teaching Hospital", type: "hospital", dist: "2.1", open24: true, phone: "01-4412404", lat: 27.7335, lng: 85.3319 },
  { name: "Kathmandu Model Hospital", type: "hospital", dist: "1.5", open24: true, phone: "01-4217766", lat: 27.7172, lng: 85.3240 },
  { name: "Shree Health Post", type: "healthpost", dist: "0.3", open24: false, phone: "01-4441234", lat: 27.7089, lng: 85.3176 },
  { name: "Green Valley Pharmacy", type: "pharmacy", dist: "0.2", open24: false, phone: "01-4556677", lat: 27.7055, lng: 85.3148 },
  { name: "Patan Hospital", type: "hospital", dist: "3.2", open24: true, phone: "01-5522266", lat: 27.6763, lng: 85.3198 },
];

const mockDoctors = [
  { id: "d1", name: "Dr. Sushila Sharma", specialization: "General Medicine", hospital: "Bir Hospital", phone: "9801234567", password: "doctor123", online: true, age: 42, gender: "Female", licenseNo: "NMC-12345", avatar: "S" },
  { id: "d2", name: "Dr. Rajesh Adhikari", specialization: "Cardiology", hospital: "TUTH", phone: "9807654321", password: "doctor123", online: true, age: 50, gender: "Male", licenseNo: "NMC-54321", avatar: "R" },
  { id: "d3", name: "Dr. Priya Joshi", specialization: "Pediatrics", hospital: "Kanti Children Hospital", phone: "9809876543", password: "doctor123", online: false, age: 38, gender: "Female", licenseNo: "NMC-99887", avatar: "P" },
];

const communityPostsData = [
  { id: 1, author: "Dr. Sushila Sharma", avatar: "S", time: "2h ago", content: "Reminder: Dengue cases are rising in Kathmandu valley. Please advise patients to use mosquito nets and eliminate stagnant water. Early symptoms include high fever, joint pain, and rash.", likes: 24, comments: 8 },
  { id: 2, author: "Dr. Rajesh Adhikari", avatar: "R", time: "5h ago", content: "New study shows that meditation combined with standard hypertension treatment reduces BP by additional 5-7 mmHg in Nepali patients. Worth discussing with patients.", likes: 31, comments: 12 },
  { id: 3, author: "Dr. Priya Joshi", avatar: "P", time: "1d ago", content: "Winter respiratory infections peaking. Seeing many children with RSV. Ensure parents know danger signs: rapid breathing, chest in-drawing, poor feeding.", likes: 45, comments: 19 },
];

const healthTipsData = [
  { icon: "H", tip: "Drink 8-10 glasses of water daily. At altitude in Nepal, dehydration happens faster — carry a water bottle everywhere.", category: "Hydration" },
  { icon: "S", tip: "Dengue & Malaria peak June-September. Use mosquito repellent, wear full sleeves, and eliminate stagnant water around your home.", category: "Seasonal" },
  { icon: "A", tip: "Altitude sickness above 2,500m: ascend slowly, rest for 2 days after every 1,000m gain, and descend immediately if symptoms worsen.", category: "Altitude" },
  { icon: "N", tip: "Eat seasonal fruits like Amlaa (gooseberry) rich in Vitamin C to boost immunity during monsoon season.", category: "Nutrition" },
  { icon: "Q", tip: "Air quality in Kathmandu valley is poor during dry season. Wear N95 masks outdoors, especially near Ratnapark and Ring Road.", category: "Air Quality" },
  { icon: "Sa", tip: "Typhoid and cholera are endemic. Always wash hands before eating, drink filtered/boiled water, and avoid raw street food.", category: "Sanitation" },
  { icon: "Sk", tip: "Apply SPF 30+ sunscreen daily. UV radiation is 25% stronger in Nepal's hills due to thinner atmosphere.", category: "Skin" },
  { icon: "W", tip: "Practice 20 minutes of pranayama daily. Breathing exercises help with both altitude adjustment and mental health.", category: "Wellness" },
  { icon: "P", tip: "Get your annual health checkup at a government hospital — CBC, blood sugar, and BP screening is free for those above 40.", category: "Preventive" },
  { icon: "Ay", tip: "Tulsi (Holy Basil) tea with ginger helps soothe respiratory infections common during monsoon. A traditional Nepali remedy.", category: "Ayurveda" },
];

const tickerTips = [
  "Stay hydrated — drink 8+ glasses of water daily",
  "Use mosquito nets during monsoon season",
  "Acclimatize slowly above 2,500m altitude",
  ...
  "UV rays are stronger at high altitude — use sunscreen",
...
// Adds all required headers for the Anthropic API to work from browser environments
...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .app[data-dark="true"] {
    background: linear-gradient(135deg,#0a1510,#0f1a16,#0a1510);
    color: #ffffff;
  }
  .app[data-dark="true"] * { color: inherit; }
  ...
  .app[data-dark="true"] .appt-form,
  .app[data-dark="true"] .map-panel { background: rgba(18,32,26,.97); border-color:rgba(255,255,255,.06); color:#ffffff; }
  .app[data-dark="true"] .sidebar { background:linear-gradient(180deg,#061009,#0a1a12); }
  .app[data-dark="true"] .fi,
  .app[data-dark="true"] .fs,
  .app[data-dark="true"] .fta,
  .app[data-dark="true"] .ci { background:rgba(255,255,255,.05); border-color:rgba(255,255,255,.1); color:#ffffff; }
  ...
  .app[data-dark="true"] .ai-bub { background:#1a2e22; color:#ffffff; }
  .app[data-dark="true"] .modal-box { background:#111d18; color:#ffffff; }
  ...
  .app[data-dark="true"] .feat-card { background:rgba(18,32,26,.8); color:#ffffff; }
  .app[data-dark="true"] .ticker { background:linear-gradient(90deg,#041008,#0a1a12); }
  .app[data-dark="true"] .info-label { color:#a0c8b8; }
  .app[data-dark="true"] .info-value { color:#ffffff; }
  .app[data-dark="true"] .sec-title { color:#a8ffdc; }
  .app[data-dark="true"] .auth-sw { background:linear-gradient(135deg,#041008,#0a1a12); color:#ffffff; }
  .app[data-dark="true"] .form-lbl { color:#a0c8b8; }
  .app[data-dark="true"] .big-title { color:#a8ffdc; }
  .app[data-dark="true"] .tagline { color:#c0e0d0; }
  .app[data-dark="true"] .subtitle { color:#a0c8b8; }
  .app[data-dark="true"] .stat-lbl { color:#c0e0d0; }
  .app[data-dark="true"] .role-title { color:#a8ffdc; }
  .app[data-dark="true"] .role-desc { color:#c0e0d0; }
  .app[data-dark="true"] .feats-title { color:#a8ffdc; }
  .app[data-dark="true"] .feat-name { color:#a8ffdc; }
  .app[data-dark="true"] .feat-desc { color:#c0e0d0; }
  .app[data-dark="true"] .auth-title { color:#a8ffdc; }
  .app[data-dark="true"] .fac-name { color:#ffffff; }
  .app[data-dark="true"] .fac-meta { color:#a0c8b8; }
  .app[data-dark="true"] .doc-name { color:#ffffff; }
  .app[data-dark="true"] .doc-spec { color:#7ec8a8; }
  .app[data-dark="true"] .doc-hosp { color:#a0c8b8; }
  .app[data-dark="true"] .post-auth { color:#ffffff; }
  .app[data-dark="true"] .post-time { color:#a0c8b8; }
  .app[data-dark="true"] .post-content { color:#c0e0d0; }
  .app[data-dark="true"] .rec-pname { color:#ffffff; }
  .app[data-dark="true"] .rec-time { color:#a0c8b8; }
  .app[data-dark="true"] .rec-content { color:#c0e0d0; }
  .app[data-dark="true"] .appt-doc { color:#ffffff; }
  .app[data-dark="true"] .appt-meta { color:#a0c8b8; }
  .app[data-dark="true"] .appt-notes { color:#c0e0d0; }
  .app[data-dark="true"] .appt-form-title { color:#a8ffdc; }
  .app[data-dark="true"] .tip-txt { color:#c0e0d0; }
  .app[data-dark="true"] .pa-btn { color:#a0c8b8; }
  .app[data-dark="true"] .alert-inf { background:rgba(180,83,9,.15); color:#fcd34d; }
  .app[data-dark="true"] .alert-ok { background:rgba(39,103,73,.2); color:#6ee7b7; }
  .app[data-dark="true"] .alert-err { background:rgba(197,48,48,.15); color:#fc8181; }
  .app[data-dark="true"] .em-txt strong { color:#ffffff; }
  .app[data-dark="true"] .em-txt span { color:rgba(255,255,255,.85); }
  .app[data-dark="true"] .bn-it { color:#a0c8b8; }
  .app[data-dark="true"] .bn-it.active { color:#7ec8a8; }
  .app[data-dark="true"] .sb-name { color:#ffffff; }
  .app[data-dark="true"] .ch-hdr { background:linear-gradient(135deg,#041008,#0a1a12); }
  .app[data-dark="true"] .stat-num { color:#a8ffdc; }
  .app[data-dark="true"] .map-info-panel { background:rgba(18,32,26,.97); border-color:rgba(255,255,255,.08); }
  .app[data-dark="true"] .map-fac-item { background:rgba(255,255,255,.04); border-color:rgba(255,255,255,.06); }
  .app[data-dark="true"] .map-fac-name { color:#ffffff; }
  .app[data-dark="true"] .map-fac-meta { color:#a0c8b8; }
  ...
  .role-icon-box { width:56px;height:56px; background:linear-gradient(135deg,var(--em),var(--em-l)); border-radius:14px; display:flex;align-items:center;justify-content:center; font-family:'Sora',sans-serif; font-size:1.4rem;font-weight:800;color:#fff; margin-bottom:14px; }
  ...
  .feat-icon-box { width:44px;height:44px; background:linear-gradient(135deg,var(--em),var(--sf)); border-radius:10px; display:flex;align-items:center;justify-content:center; font-family:'Sora',sans-serif; font-size:.9rem;font-weight:800;color:#fff; margin:0 auto 10px; }
  ...
  .auth-icon-box { width:60px;height:60px; background:linear-gradient(135deg,var(--em),var(--em-l)); border-radius:16px; display:flex;align-items:center;justify-content:center; font-family:'Sora',sans-serif; font-size:1.4rem;font-weight:800;color:#fff; margin:0 auto 10px; }
  ...
  .sb-av { width:56px;height:56px; background:rgba(255,255,255,.14); border-radius:50%; display:flex; align-items:center; justify-content:center; font-family:'Sora',sans-serif; font-size:1.4rem;font-weight:800;color:#fff; margin:0 auto 8px; border:2px solid rgba(255,255,255,.22); }
  ...
  .nav-dot { width:8px;height:8px;border-radius:50%; background:rgba(255,255,255,.3); display:inline-block; flex-shrink:0; }
  .nav-it.active .nav-dot { background:var(--sf-l); }
  .nav-badge { background:var(--sf); color:#fff; font-size:.58rem; font-weight:700; padding:1px 6px; border-radius:100px; margin-left:auto; }
  ...
  .sc-icon { width:32px;height:32px; background:rgba(255,255,255,.15); border-radius:8px; display:flex;align-items:center;justify-content:center; font-family:'Sora',sans-serif; font-size:.8rem;font-weight:800;color:#fff; }
  ...
  .tip-icon-box { width:50px;height:50px; background:linear-gradient(135deg,var(--em),var(--sf)); border-radius:12px; display:flex;align-items:center;justify-content:center; font-family:'Sora',sans-serif; font-size:.75rem;font-weight:800;color:#fff; flex-shrink:0; }
  ...
  .ch-av { width:36px;height:36px; background:rgba(255,255,255,.14); border-radius:50%; display:flex; align-items:center; justify-content:center; font-family:'Sora',sans-serif; font-size:.9rem;font-weight:800;color:#fff; }
  ...
  .map-container { border-radius:var(--r); overflow:hidden; box-shadow:var(--sh-lg); border:1px solid rgba(13,92,74,.1); margin-bottom:20px; position:relative; }
  .map-wrap { height:420px; width:100%; }
  .map-locating { position:absolute; top:12px; left:50%; transform:translateX(-50%); background:rgba(13,92,74,.92); color:#fff; padding:7px 14px; border-radius:100px; font-size:.76rem; font-weight:600; z-index:999; display:flex; align-items:center; gap:6px; backdrop-filter:blur(8px); }
  .leaflet-container { height:100%; width:100%; border-radius:0; z-index:1; }
  .map-info-panel { background:var(--card); border-radius:var(--r); padding:18px; box-shadow:var(--sh); border:1px solid rgba(13,92,74,.07); margin-bottom:16px; }
  .map-info-title { font-family:'Sora',sans-serif; font-size:.9rem; font-weight:700; color:var(--em-d); margin-bottom:12px; display:flex; align-items:center; gap:6px; }
  .map-fac-list { display:flex; flex-direction:column; gap:7px; max-height:280px; overflow-y:auto; }
  .map-fac-item { display:flex; align-items:center; gap:10px; padding:9px 12px; border-radius:var(--r-sm); border:1px solid rgba(13,92,74,.08); background:rgba(13,92,74,.03); cursor:pointer; transition:all .2s; }
  .map-fac-item:hover { background:rgba(13,92,74,.08); border-color:rgba(13,92,74,.2); transform:translateX(3px); }
  .map-fac-item.selected { background:rgba(13,92,74,.1); border-color:var(--em); }
  .map-fac-dot { width:12px;height:12px; border-radius:50%; flex-shrink:0; }
  .map-fac-dot.hospital { background:var(--em); }
  .map-fac-dot.healthpost { background:#3182ce; }
  .map-fac-dot.pharmacy { background:var(--sf); }
  .map-fac-info { flex:1; }
  .map-fac-name { font-size:.82rem; font-weight:700; color:var(--td); }
  .map-fac-meta { font-size:.7rem; color:var(--tl); }
  .map-dir-btn { background:linear-gradient(135deg,var(--em),var(--em-l)); color:#fff; border:none; padding:5px 12px; border-radius:100px; font-size:.68rem; font-weight:600; cursor:pointer; font-family:'Noto Sans Devanagari',sans-serif; white-space:nowrap; transition:all .2s; }
  .map-dir-btn:hover { opacity:.88; transform:scale(1.04); }
  ...
  .doc-av { width:56px;height:56px; background:linear-gradient(135deg,var(--em),var(--em-l)); border-radius:50%; display:flex; align-items:center; justify-content:center; font-family:'Sora',sans-serif; font-size:1.4rem;font-weight:800;color:#fff; margin-bottom:10px; border:3px solid rgba(13,92,74,.12); }
  ...
  .appt-ic { width:40px;height:40px; background:linear-gradient(135deg,var(--em),var(--em-l)); border-radius:10px; display:flex;align-items:center;justify-content:center; font-family:'Sora',sans-serif; font-size:.85rem;font-weight:800;color:#fff; flex-shrink:0; margin-top:2px; }
  ...
  .pt-connect-card { background:var(--card); border-radius:var(--r); padding:20px; box-shadow:var(--sh); border:1px solid rgba(13,92,74,.06); border-left:4px solid #6c3483; animation:fadeUp .4s ease both; margin-bottom:12px; }
  .pt-connect-hdr { display:flex; align-items:flex-start; gap:14px; margin-bottom:12px; }
  .pt-connect-av { width:50px;height:50px; background:linear-gradient(135deg,#6c3483,#8e44ad); border-radius:50%; display:flex; align-items:center; justify-content:center; font-family:'Sora',sans-serif; font-size:1.2rem;font-weight:800;color:#fff; flex-shrink:0; }
  .pt-connect-name { font-weight:700; font-size:.95rem; color:var(--td); }
  .pt-connect-meta { font-size:.74rem; color:var(--tl); margin-top:2px; }
  .pt-connect-report { background:rgba(13,92,74,.04); border:1px solid rgba(13,92,74,.09); border-radius:var(--r-sm); padding:10px 12px; font-size:.76rem; color:var(--tm); line-height:1.6; white-space:pre-wrap; max-height:120px; overflow-y:auto; margin-bottom:12px; }
  .pt-connect-btns { display:flex; gap:6px; flex-wrap:wrap; }
  ...
  .post-av { width:38px;height:38px; background:linear-gradient(135deg,var(--em),var(--sf)); border-radius:50%; display:flex;align-items:center;justify-content:center; font-family:'Sora',sans-serif; font-size:1rem;font-weight:800;color:#fff; }
  ...
  .em-txt strong { display:block; font-size:.85rem; color:#fff; }
  .em-txt span { font-size:.73rem; opacity:.85; color:#fff; }
  ...
  .call-anim { width:72px;height:72px; border-radius:50%; background:rgba(13,92,74,.1); display:flex; align-items:center; justify-content:center; font-family:'Sora',sans-serif; font-size:1.1rem;font-weight:800;color:var(--em); margin:0 auto 20px; animation:callPulse 1.5s ease-in-out infinite; }
  ...
  .bn-icon { width:22px;height:22px;background:currentColor;border-radius:4px;opacity:.25;transition:all .2s; }
  .bn-it.active .bn-icon { opacity:.6; transform:scale(1.1); }
...
function LeafletMap({ facilities, userLat, userLng, selectedFac, onSelectFac, t }) {
  ...
  useEffect(() => {
    ...
    const initMap = () => {
      ...
      const L = window.L;
      const lat = userLat || 27.7172;
      const lng = userLng || 85.3240;
      ...
      if (userLat && userLng) {
        const userIcon = L.divIcon({
          html: `<div style="width:20px;height:20px;background:#e53e3e;border:3px solid #fff;border-radius:50%;box-shadow:0 2px 8px rgba(229,62,62,.6);"></div>`,
      ...
      const colors = { hospital: "#0d5c4a", healthpost: "#3182ce", pharmacy: "#e8890c" };
      facilities.forEach((fac, i) => {
        const color = colors[fac.type] || "#666";
        const icon = L.divIcon({
          html: `<div style="width:32px;height:32px;background:${color};border:3px solid #fff;border-radius:8px;box-shadow:0 3px 10px rgba(0,0,0,.25);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:800;color:#fff;font-family:Sora,sans-serif;">${fac.type==="hospital"?"H":fac.type==="pharmacy"?"Rx":"HP"}</div>`,
          className: "", iconAnchor: [16, 16]
        });
        const marker = L.marker([fac.lat, fac.lng], { icon })
          .addTo(map)
          .bindPopup(`<strong>${fac.name}</strong><br/>${fac.dist} km away<br/>${fac.phone}${fac.open24 ? '<br/><span style="color:#276749;font-weight:600;">Open 24/7</span>' : ''}`);
        marker.on("click", () => onSelectFac(i));
  ...
  useEffect(() => {
    if (selectedFac === null || !mapInstanceRef.current) return;
    const fac = facilities[selectedFac];
    if (fac) {
      mapInstanceRef.current.flyTo([fac.lat, fac.lng], 16, { duration: 1 });
      markersRef.current[selectedFac]?.openPopup();
    }
  }, [selectedFac]);
  ...
  useEffect(() => {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        () => { setLocating(false); showToast(t.locError, "inf"); }
      );
    } else { setLocating(false); }
  }, []);

  const openDirections = (fac) => {
    const lat = userLat || 27.7172;
    const lng = userLng || 85.3240;
    window.open(`https://www.openstreetmap.org/directions?from=${lat},${lng}&to=${fac.lat},${fac.lng}&engine=osrm_car`, "_blank");
  };

  return (
    <>
      <div className="sec-title">{t.nearby}</div>
      <div className="em-strip" style={{ marginBottom: 16 }}>
        <div style={{ width: 36, height: 36, background: "rgba(255,255,255,.2)", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Sora,sans-serif", fontSize: ".65rem", fontWeight: 800, color: "#fff", flexShrink: 0 }}>AMB</div>
        <div className="em-txt" style={{ flex: 1 }}>
          <strong>Emergency Ambulance</strong>
          <span>Nepal Ambulance: 102 | Red Cross: 01-4228094</span>
        </div>
        <button className="amb-btn" onClick={() => showToast("Calling 102 — Ambulance dispatched!", "inf")}>Call 102</button>
      </div>
      <div className="map-container">
        ...
        <div className="map-wrap">
          <LeafletMap facilities={mockFacilities} userLat={userLat} userLng={userLng} selectedFac={selectedFac} onSelectFac={setSelectedFac} t={t} />
        </div>
      </div>
      <div className="map-info-panel">
        <div className="map-info-title">
          <span style={{ width: 10, height: 10, borderRadius: "50%", background: "var(--em)", display: "inline-block" }} />
          {t.mapTitle}
        </div>
        <div className="map-fac-list">
          {mockFacilities.map((fac, i) => (
            <div key={i} className={`map-fac-item ${selectedFac === i ? "selected" : ""}`} onClick={() => setSelectedFac(i)}>
              <div className={`map-fac-dot ${fac.type}`} />
              <div className="map-fac-info">
                <div className="map-fac-name">{fac.name}</div>
                <div className="map-fac-meta">{fac.dist} {t.km} · {fac.phone}{fac.open24 ? " · 24/7" : ""}</div>
              </div>
              <button className="map-dir-btn" onClick={(e) => { e.stopPropagation(); openDirections(fac); }}>{t.getDirections}</button>
            </div>
          ))}
        </div>
      </div>
      <div className="fac-grid">
        {mockFacilities.map((f, i) => (
          <div key={i} className={`fac-card ${f.type}`} style={{ animationDelay: `${i * .07}s`, cursor: "pointer" }} onClick={() => { setSelectedFac(i); window.scrollTo({ top: 0, behavior: "smooth" }); }}>
            ...
            <div className="fac-meta">
              ...
              {f.open24 && <span className="o24-bdg">{t.open24}</span>}
              <span>{f.phone}</span>
            </div>
            <button className="con-btn" style={{ marginTop: 8, background: "linear-gradient(135deg,#3182ce,#2b6cb0)", width: "100%" }} onClick={(e) => { e.stopPropagation(); openDirections(f); }}>{t.getDirections}</button>
          </div>
        ))}
      </div>
    </>
      ...
      <div className="app" data-dark={darkMode}>
        <header className="hdr">
          <div className="hdr-logo" onClick={logout}>
            <div style={{ width: 42, height: 42, borderRadius: "50%", background: "rgba(255,255,255,.18)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Sora,sans-serif", fontSize: "1rem", fontWeight: 800, color: "#fff", border: "2px solid rgba(255,255,255,.3)" }}>HC</div>
          ...
          <div className="hdr-acts">
            <button className="dark-btn" onClick={() => setDarkMode(d => !d)} style={{ fontSize: ".65rem", fontFamily: "Sora,sans-serif", fontWeight: 700 }}>{darkMode ? "LT" : "DK"}</button>
        ...
        {page === "patient-intake" && <PatientIntake t={t} patients={patients} setPatients={setPatients} setCurrentPatient={setCurrentPatient} setPage={setPage} showToast={showToast} setActiveSection={setActiveSection} />}
        {page === "patient-dashboard" && currentPatient && (
          <PatientDashboard
            t={t} lang={lang} patient={currentPatient}
            activeSection={activeSection} setActiveSection={setActiveSection}
            doctors={doctors} sentReports={sentReports} setSentReports={setSentReports}
            appointments={appointments} setAppointments={setAppointments}
            aiConvCount={aiConvCount} setAiConvCount={setAiConvCount}
            setModal={setModal} showToast={showToast}
          />
        )}
        {page === "doctor-auth" && (
          <DoctorAuth t={t} mode={doctorAuthMode} setMode={setDoctorAuthMode}
            doctors={doctors} setDoctors={setDoctors}
            setCurrentDoctor={setCurrentDoctor} setPage={setPage} showToast={showToast}
          />
        )}
        {page === "doctor-dashboard" && currentDoctor && (
          <DoctorDashboard
            t={t} lang={lang} doctor={currentDoctor}
            activeSection={activeSection} setActiveSection={setActiveSection}
            sentReports={sentReports} patients={patients} doctors={doctors}
            setModal={setModal} showToast={showToast}
          />
        )}
...
function LandingPage({ t, setPage }) {
  ...
  const stats = [{ label: "Patients Served", target: 10000, suffix: "+", abbr: "PT" }, { label: "Doctors", target: 500, suffix: "+", abbr: "DR" }, { label: "Hospitals", target: 50, suffix: "+", abbr: "HP" }, { label: "Success Rate", target: 98, suffix: "%", abbr: "SR" }];
  const feats = [
    { abbr: "AI", name: "AI Diagnosis", desc: "Symptom analysis powered by medical AI trained on Nepali healthcare data" },
    { abbr: "DC", name: "Doctor Connect", desc: "Video, audio & chat consultations with verified Nepali doctors" },
    { abbr: "ER", name: "Emergency", desc: "One-tap ambulance call & real-time emergency service integration" },
    { abbr: "MP", name: "Live Map", desc: "Real-time map showing nearby hospitals, clinics & pharmacies with directions" },
    { abbr: "ML", name: "Multi-Language", desc: "Full support for Nepali, Maithili, Bhojpuri and English" },
  ];
  return (
    <div className="landing">
        ...
        {stats.map((s, i) => (
          <div key={i} style={{ display: "contents" }}>
            <div className="stat-it">
              <div className="stat-num"><StatCount target={s.target} suffix={s.suffix} start={sv} /></div>
      ...
      <div className="role-cards">
        <div className="role-card" onClick={() => setPage("patient-intake")}>
          <div className="role-icon-box">PT</div>
          <div className="role-title">{t.iAmPatient}</div>
          <div className="role-desc">Access AI health assistant, connect with doctors, find nearby facilities on live map</div>
        </div>
        <div className="role-card" onClick={() => setPage("doctor-auth")}>
          <div className="role-icon-box">DR</div>
          <div className="role-title">{t.iAmDoctor}</div>
          <div className="role-desc">Receive patient AI reports instantly, connect with patients, join doctor community</div>
        </div>
      </div>
        ...
        <div className="feats-grid">
          {feats.map((f, i) => (
            <div key={i} className="feat-card">
              <div className="feat-icon-box">{f.abbr}</div>
...
function PatientIntake({ t, patients, setPatients, setCurrentPatient, setPage, showToast, setActiveSection }) {
  const [form, setForm] = useState({ name: "", age: "", gender: "Male", address: "", phone: "", blood: "A+", currentMeds: "", physicalConditions: "" });
  const [err, setErr] = useState("");
  const bgs = ["A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-"];

  const proceed = () => {
    if (!form.name || !form.age || !form.phone) { setErr(t.required); return; }
    const newPatient = { ...form, id: Date.now().toString(), avatar: form.name.charAt(0).toUpperCase() };
    ...
    <div className="auth-wrap">
      <div className="auth-card">
        <div className="auth-hdr">
          <div className="auth-icon-box">PT</div>
          <div className="auth-title">{t.patientRegister}</div>
          <p style={{ fontSize: ".8rem", color: "var(--tl)", marginTop: 6 }}>Please fill in your details to get started</p>
        </div>
        {err && <div className="alert alert-err">{err}</div>}
        <div className="form-grid">
          <div className="form-grp"><label className="form-lbl">{t.name} *</label><input className="fi" value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} placeholder="Your full name" /></div>
          <div className="form-grp"><label className="form-lbl">{t.age} *</label><input className="fi" type="number" value={form.age} onChange={e => setForm({ ...form, age: e.target.value })} placeholder="Age" /></div>
          ...
          <div className="form-grp full"><label className="form-lbl">{t.phone} *</label><input className="fi" type="tel" value={form.phone} onChange={e => setForm({ ...form, phone: e.target.value })} placeholder="Phone number" /></div>
          <div className="form-grp full"><label className="form-lbl">{t.address}</label><input className="fi" value={form.address} onChange={e => setForm({ ...form, address: e.target.value })} placeholder="Your address (optional)" /></div>
          <div className="form-grp full"><label className="form-lbl">{t.currentMeds}</label><textarea className="fta" value={form.currentMeds} onChange={e => setForm({ ...form, currentMeds: e.target.value })} placeholder="e.g., Metformin 500mg — leave blank if none" /></div>
          <div className="form-grp full"><label className="form-lbl">{t.physicalConditions}</label><textarea className="fta" value={form.physicalConditions} onChange={e => setForm({ ...form, physicalConditions: e.target.value })} placeholder="e.g., Diabetes, Hypertension — leave blank if none" /></div>
          <div className="form-grp full"><button className="btn-p" onClick={proceed}>{t.submit}</button></div>
        </div>
...
function PatientDashboard({ t, lang, patient, activeSection, setActiveSection, doctors, sentReports, setSentReports, appointments, setAppointments, aiConvCount, setAiConvCount, setModal, showToast }) {
  const navItems = [
    { id: "info", label: t.myInfo, abbr: "ME" },
    { id: "chatbot", label: t.aiChatbot, abbr: "AI" },
    { id: "facilities", label: t.nearbyFacilities, abbr: "NR" },
    { id: "doctors", label: t.connectDoctor, abbr: "DR" },
    { id: "appointments", label: t.appointments, abbr: "AP" },
    { id: "tips", label: t.healthTips, abbr: "TI" }
  ];
  return (
    <div className="dash">
      <aside className="sidebar">
        <div className="sb-user">
          <div className="sb-av">{patient.name.charAt(0).toUpperCase()}</div>
          <div className="sb-name">{patient.name}</div>
          <div className="sb-role">Patient</div>
        </div>
        {navItems.map(it => (
          <button key={it.id} className={`nav-it ${activeSection === it.id ? "active" : ""}`} onClick={() => setActiveSection(it.id)}>
      ...
      <div className="bnav">
        {navItems.map(it => (
          <button key={it.id} className={`bn-it ${activeSection === it.id ? "active" : ""}`} onClick={() => setActiveSection(it.id)}>
            <div className="bn-icon"></div>
            <span className="bn-lbl">{it.label.split(" ")[0]}</span>
          </button>
        ))}
      </div>
      <main className="main">
...
function PatientInfo({ t, patient, sentReports, aiConvCount, appointments, doctors }) {
  ...
  const scs = [
    { abbr: "AI", label: t.aiConversations, value: aiConvCount },
    { abbr: "RP", label: t.reportsGenerated, value: sentReports.length },
    { abbr: "DR", label: t.connectedDoctors, value: doctors.filter(d => d.online).length },
    { abbr: "HS", label: t.healthScore, value: 87 }
  ];
  const ifs = [
    ...
    <>
      ...
      <div className="pt-stats">
        {scs.map((s, i) => (
          <div key={i} className="stat-card" style={{ animationDelay: `${i * .07}s` }}>
            <div className="sc-icon" style={{ fontSize: ".65rem" }}>{s.abbr}</div>
      ...
      {patient.currentMeds && (
        <div className="info-card" style={{ marginBottom: 10 }}>
          ...
          <div className="info-value" style={{ fontSize: ".85rem", fontWeight: 400, marginTop: 4 }}>{patient.currentMeds}</div>
        </div>
      )}
      {patient.physicalConditions && (
        <div className="info-card" style={{ marginBottom: 14 }}>
          <div className="info-label">{t.physicalConditions}</div>
          <div className="info-value" style={{ fontSize: ".85rem", fontWeight: 400, marginTop: 4 }}>{patient.physicalConditions}</div>
        </div>
      )}
      <div className="em-strip">
        <div style={{ width: 36, height: 36, background: "rgba(255,255,255,.2)", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Sora,sans-serif", fontSize: ".75rem", fontWeight: 800, color: "#fff", flexShrink: 0 }}>SOS</div>
        <div className="em-txt" style={{ flex: 1 }}>
    ...
    <>
      ...
      <div style={{ marginBottom: 20 }}>
        <div className="tip-sl" key={key}>
          <div className="tip-icon-box">{tip.category.slice(0, 2).toUpperCase()}</div>
          <div style={{ flex: 1 }}>
            <span className="tip-cat">{tip.category}</span>
            <p className="tip-txt">{tip.tip}</p>
          </div>
        </div>
          ...
          {healthTipsData.map((tip, i) => (
            <div key={i} className="info-card" style={{ cursor: "pointer", borderLeft: "3px solid var(--em)" }} onClick={() => goto(i)}>
              <div style={{ display: "flex", gap: 9, alignItems: "flex-start" }}>
                <div style={{ width: 36, height: 36, background: "linear-gradient(135deg,var(--em),var(--sf))", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Sora,sans-serif", fontSize: ".65rem", fontWeight: 800, color: "#fff", flexShrink: 0 }}>{tip.category.slice(0, 2).toUpperCase()}</div>
                <div>
                  <span className="tip-cat" style={{ marginBottom: 3 }}>{tip.category}</span>
                  <p style={{ fontSize: ".76rem", color: "var(--tm)", lineHeight: 1.5 }}>{tip.tip.slice(0, 80)}...</p>
                </div>
              </div>
            </div>
          ))}
...
// ─── AI Chatbot — FIXED: added required anthropic-version and browser-access headers ─
function AIChatbot({ t, lang, patient, doctors, sentReports, setSentReports, setAiConvCount, showToast }) {
  const [messages, setMessages] = useState([{ role: "assistant", content: `Namaste ${patient.name}! I am your AI Health Assistant. Please describe your symptoms and I will help you understand what might be happening.\n\n${t.disclaimer}` }]);
  ...
  const sysPr = `You are a health assistant for Nepal called हाम्रो-CARE. Respond in ${langNames[lang] || "English"}. Patient: ${patient.name}, Age: ${patient.age}, Gender: ${patient.gender}, Blood: ${patient.blood}, Medications: ${patient.currentMeds || "None"}, Physical Conditions: ${patient.physicalConditions || "None"}. Analyze symptoms, suggest possible conditions (not diagnosis), recommend OTC medicines available in Nepal, and advise when to seek emergency care. Reference common Nepali diseases (dengue, typhoid, altitude sickness). Be warm and culturally sensitive. Always remind this is not professional advice.`;
  ...
  const send = async () => {
    ...
    try {
      ...
      // ✅ FIX: Added anthropic-version and anthropic-dangerous-direct-browser-access headers
      ...
      setMessages(p => [...p, { role: "assistant", content: `Connection error: ${err.message}. Please try again.` }]);
    }
    setLoading(false);
  };
  ...
  const genReport = async () => {
    ...
    try {
      ...
      const data = await callAnthropicAPI({
        model: "claude-sonnet-4-20250514",
        max_tokens: 1000,
        system: "Generate a structured medical report from patient-AI conversation for Nepal healthcare.",
        messages: [{ role: "user", content: `Generate a formal medical report. Include: Patient Details, Chief Complaints, Symptom Analysis, Possible Conditions, Medications Suggested, Urgency Level (High/Medium/Low), Recommendations.\n\nPatient: ${patient.name}, ${patient.age}y, ${patient.gender}, ${patient.blood}\nMedications: ${patient.currentMeds || "None"}\nConditions: ${patient.physicalConditions || "None"}\n\nConversation:\n${conv}` }],
      });
      const report = data.content?.[0]?.text || "Unable to generate report.";
      const nr = {
        id: Date.now(),
        patientName: patient.name, patientAge: patient.age,
        patientGender: patient.gender, blood: patient.blood,
      ...
      setSentReports(p => [nr, ...p]);
      setLastReport(report);
      setRepModal(report);
      setReportSent(true);
      showToast(t.reportSent, "ok");
    } catch (err) {
  ...
  return (
    <>
      {repModal && (
        <div className="mo" onClick={() => setRepModal(null)}>
          <div className="modal-box rep-modal" onClick={e => e.stopPropagation()}>
            <div className="auth-hdr">
              <div className="auth-icon-box">RP</div>
      ...
      {reportSent && (
        <div className="alert alert-ok" style={{ marginBottom: 12, display: "flex", alignItems: "center", gap: 8 }}>
          <span>✅</span>
          <span>{t.reportSent} Doctors can now see your report and connect with you.</span>
          <button className="btn-s" style={{ marginLeft: "auto", padding: "3px 10px", fontSize: ".72rem" }} onClick={() => setRepModal(lastReport)}>View Report</button>
        </div>
      )}
      <div className="chatbox">
        <div className="ch-hdr">
          <div className="ch-av">AI</div>
          <div>
            <div className="ch-name">हाम्रो-CARE AI</div>
            <div className="ch-status"><span className="sdot"></span> Online · Medical AI</div>
          </div>
        </div>
          ...
          {loading && (
            <div className="msg msg-a">
              <div className="ai-bub">
                ...
                <span style={{ fontSize: ".72rem", color: "var(--tl)", marginLeft: 6 }}>{t.loading}</span>
              </div>
            </div>
          )}
          <div ref={endRef} />
        ...
        <div style={{ padding: "10px 12px", background: "linear-gradient(135deg,rgba(13,92,74,.04),rgba(232,137,12,.04))", borderTop: "1px solid rgba(13,92,74,.06)", display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          <button
            style={{ background: reportSent ? "rgba(39,103,73,.15)" : "linear-gradient(135deg,#0d5c4a,#10735c)", color: reportSent ? "#276749" : "#fff", border: reportSent ? "1.5px solid #276749" : "none", borderRadius: "var(--r-sm)", padding: "9px 18px", fontSize: ".82rem", fontWeight: 700, cursor: messages.length < 3 ? "not-allowed" : "pointer", fontFamily: "'Noto Sans Devanagari',sans-serif", transition: "all .25s", opacity: messages.length < 3 ? .5 : 1, display: "flex", alignItems: "center", gap: 6, boxShadow: reportSent ? "none" : "0 4px 12px rgba(13,92,74,.22)", flex: 1, justifyContent: "center" }}
            onClick={genReport}
            disabled={messages.length < 3 || loading}
          >
            {reportSent ? "✅ " : "📋 "}
            {reportSent ? t.reportAlreadySent : t.generateReport}
          </button>
          {messages.length < 3 && <span style={{ fontSize: ".7rem", color: "var(--tl)" }}>Chat with AI first to generate a report</span>}
        </div>
      </div>
    </>
  );
...
function ConnectDoctor({ t, doctors, setModal }) {
  return (
    <>
      <div className="sec-title">{t.connectDoctor}</div>
      <div className="doc-cards">
        {doctors.map((doc, i) => (
          <div key={doc.id} className="doc-card" style={{ animationDelay: `${i * .07}s` }}>
            <div className="doc-av">{doc.name.charAt(doc.name.indexOf(".") + 2) || "D"}</div>
            ...
            <div style={{ display: "flex", gap: 5, marginTop: 8 }}>
              ...
              <button className="con-btn" style={{ background: "linear-gradient(135deg,#3182ce,#2b6cb0)" }} onClick={() => setModal({ type: "call", callType: "audio", doctor: doc })}>Audio</button>
              <button className="con-btn" style={{ background: "linear-gradient(135deg,#805ad5,#6b46c1)" }} onClick={() => setModal({ type: "call", callType: "video", doctor: doc })}>Video</button>
            </div>
          </div>
        ))}
      </div>
  ...
  return (
    <>
      ...
      {appointments.length === 0 ? (
        <div className="info-card" style={{ textAlign: "center", padding: 32, color: "var(--tl)" }}>
          <div style={{ fontFamily: "Sora,sans-serif", fontSize: "2rem", fontWeight: 800, color: "rgba(13,92,74,.15)", marginBottom: 8 }}>AP</div>
          <div>{t.noAppts}</div>
        </div>
      ) : (
        <div className="appt-list">
          {appointments.map((a, i) => (
            <div key={a.id} className="appt-card" style={{ animationDelay: `${i * .06}s` }}>
              <div className="appt-ic">{(a.doctor?.name || "D").charAt((a.doctor?.name || "D").indexOf(".") + 2) || "D"}</div>
              <div style={{ flex: 1 }}>
              ...
              <div className="appt-status">
                <span className="appt-bdg">Confirmed</span>
                <span style={{ fontSize: ".65rem", color: "var(--tl)" }}>Booked {a.bookedAt}</span>
              </div>
            </div>
          ))}
        </div>
...
function DoctorAuth({ t, mode, setMode, doctors, setDoctors, setCurrentDoctor, setPage, showToast }) {
  ...
  const [verified, setVd] = useState(false);

  const vLic = () => {
    if (!form.licenseNo) return;
    setV(true);
    setTimeout(() => { setV(false); setVd(true); }, 1800);
  };
  const reg = () => {
    ...
    setDoctors(p => [...p, { ...form, id: Date.now().toString(), avatar: form.name.charAt(0).toUpperCase(), online: true }]);
  ...
  const login = () => {
    ...
    if (f) { setCurrentDoctor(f); setPage("doctor-dashboard"); }
    else setErr("Invalid phone or password.");
  };
  return (
    <div className="auth-wrap">
      <div className="auth-card">
        <div className="auth-sw" style={{ background: "linear-gradient(135deg,var(--em-d),var(--em))", borderRadius: "var(--r-sm)", padding: "12px 16px", marginBottom: 20, display: "flex", alignItems: "center", justifyContent: "space-between", color: "rgba(255,255,255,.85)", fontSize: ".82rem", gap: 10 }}>
          <span>{mode === "register" ? t.alreadyHaveAccount : t.noAccount}</span>
          <button style={{ background: "var(--sf)", border: "none", color: "#fff", padding: "5px 14px", borderRadius: "100px", cursor: "pointer", fontSize: ".76rem", fontWeight: 600, fontFamily: "'Noto Sans Devanagari',sans-serif", transition: "all .2s" }} onClick={() => { setMode(mode === "register" ? "login" : "register"); setErr(""); }}>{mode === "register" ? t.loginHere : t.registerHere}</button>
        </div>
        <div className="auth-hdr">
          <div className="auth-icon-box">DR</div>
        ...
        {mode === "register" ? (
          <div className="form-grid">
            ...
            <div className="form-grp full" style={{ background: "rgba(13,92,74,.04)", border: "1.5px dashed rgba(13,92,74,.2)", borderRadius: "var(--r-sm)", padding: 12, textAlign: "center", cursor: "pointer", fontSize: ".78rem", color: "var(--tl)" }}>{t.docCertificate}</div>
          ...
          <div className="form-grid">
            ...
            <div className="form-grp full">
              <div className="alert alert-inf">Demo: phone 9801234567 · password doctor123</div>
              <button className="btn-p" onClick={login}>{t.login}</button>
            </div>
          </div>
        )}
        <div style={{ marginTop: 12 }}><button className="btn-s" onClick={() => setPage("landing")}>{t.back}</button></div>
...
function DoctorDashboard({ t, lang, doctor, activeSection, setActiveSection, sentReports, patients, doctors, setModal, showToast }) {
  ...
  const reportPatients = sentReports.reduce((acc, r) => {
    if (!acc.find(p => p.patientId === r.patientId)) {
      acc.push({ patientId: r.patientId, patientName: r.patientName, patientAge: r.patientAge, patientGender: r.patientGender, blood: r.blood, phone: r.phone, address: r.address, latestReport: r, reportCount: sentReports.filter(x => x.patientId === r.patientId).length });
    }
    return acc;
  }, []);

  const navItems = [
    { id: "info", label: t.myInfo },
    { id: "records", label: t.patientRecords, badge: sentReports.length > 0 ? sentReports.length : null },
    { id: "patientConnect", label: t.patientConnect, badge: reportPatients.length > 0 ? reportPatients.length : null },
    { id: "community", label: t.docCommunity },
  ];

  const addPost = () => {
    if (!np.trim()) return;
    setPosts(p => [{ id: Date.now(), author: doctor.name, avatar: doctor.name.charAt(0).toUpperCase(), time: "Just now", content: np, likes: 0, comments: 0 }, ...p]);
    setNp("");
  ...
  return (
    <div className="dash">
      <aside className="sidebar">
        <div className="sb-user">
          <div className="sb-av">{doctor.name.charAt(0).toUpperCase()}</div>
          <div className="sb-name">{doctor.name}</div>
          <div className="sb-role">{doctor.specialization || "Doctor"}</div>
          {doctor.online && <span className="on-bdg" style={{ marginTop: 4 }}>Online</span>}
        </div>
        {navItems.map(it => (
          <button key={it.id} className={`nav-it ${activeSection === it.id ? "active" : ""}`} onClick={() => setActiveSection(it.id)}>
            <span className="nav-dot"></span> {it.label}
      ...
      <main className="main">
        {activeSection === "info" && (
          <>
            ...
            <div className="pt-stats" style={{ gridTemplateColumns: "repeat(3,1fr)" }}>
              <div className="stat-card"><div className="sc-icon" style={{ fontSize: ".65rem" }}>RP</div><div className="sc-val">{sentReports.length}</div><div className="sc-lbl">Reports Received</div></div>
              <div className="stat-card"><div className="sc-icon" style={{ fontSize: ".65rem" }}>PT</div><div className="sc-val">{reportPatients.length}</div><div className="sc-lbl">Patients</div></div>
              <div className="stat-card"><div className="sc-icon" style={{ fontSize: ".65rem" }}>HI</div><div className="sc-val">{sentReports.filter(r => r.urgency === "high").length}</div><div className="sc-lbl">High Priority</div></div>
            </div>
            <div className="info-grid">
              {[
            ...
            <div className="info-card">
              ...
              <div style={{ marginTop: 4 }}><span className="ver-bdg">{t.licenseVerified} — Nepal Medical Council</span></div>
            </div>
          </>
        )}
        ...
        {activeSection === "records" && (
          <>
            ...
            {sentReports.length === 0 ? (
              <div className="info-card" style={{ textAlign: "center", padding: 36, color: "var(--tl)" }}>
                <div style={{ fontFamily: "Sora,sans-serif", fontSize: "2.5rem", fontWeight: 800, color: "rgba(13,92,74,.1)", marginBottom: 12 }}>📋</div>
                <div style={{ fontWeight: 600, marginBottom: 6 }}>No Patient Reports Yet</div>
                <div style={{ fontSize: ".8rem" }}>{t.noPatientReports}</div>
              </div>
            ) : sentReports.map((r, i) => (
              <div key={r.id} className={`rec-card ${r.urgency === "high" ? "u-high" : ""}`} style={{ animationDelay: `${i * .06}s` }}>
                <div className="rec-hdr">
                  <div>
                    <div className="rec-pname">
                      {r.patientName} — {r.patientAge}y — {r.patientGender} — {r.blood}
                      {r.phone && <span style={{ color: "var(--tl)", fontSize: ".75rem", marginLeft: 8 }}>📞 {r.phone}</span>}
                    </div>
                    <div className="rec-time">{t.reportedAt}: {r.time}</div>
                  </div>
                  <span className={`urg-bdg ${r.urgency}`}>{r.urgency === "high" ? t.urgencyHigh : r.urgency === "medium" ? t.urgencyMed : t.urgencyLow}</span>
                </div>
                <div className="rec-content">{r.content}</div>
                <div style={{ display: "flex", gap: 6, marginTop: 10 }}>
                  <button className="con-btn" style={{ flex: "none", padding: "6px 14px" }} onClick={() => setModal({ type: "chat", doctor: { name: r.patientName, avatar: r.patientName.charAt(0) } })}>💬 {t.chat}</button>
                  <button className="con-btn" style={{ flex: "none", padding: "6px 14px", background: "linear-gradient(135deg,#3182ce,#2b6cb0)" }} onClick={() => setModal({ type: "call", callType: "audio", doctor: { name: r.patientName } })}>📞 Audio</button>
                  <button className="con-btn" style={{ flex: "none", padding: "6px 14px", background: "linear-gradient(135deg,#805ad5,#6b46c1)" }} onClick={() => setModal({ type: "call", callType: "video", doctor: { name: r.patientName } })}>📹 Video</button>
                  <button className="btn-s" onClick={() => showToast("Appointment request sent to patient!", "ok")}>Schedule Appointment</button>
                </div>
              </div>
            ))}
          </>
        ...
        {activeSection === "patientConnect" && (
          <>
            <div className="sec-title">{t.patientConnect}</div>
            {reportPatients.length === 0 ? (
              <div className="info-card" style={{ textAlign: "center", padding: 36, color: "var(--tl)" }}>
                <div style={{ fontFamily: "Sora,sans-serif", fontSize: "2.5rem", fontWeight: 800, color: "rgba(13,92,74,.1)", marginBottom: 12 }}>👥</div>
                <div style={{ fontWeight: 600, marginBottom: 6 }}>No Patients Connected Yet</div>
                <div style={{ fontSize: ".8rem" }}>Patients who send AI-generated reports will appear here so you can connect with them.</div>
              </div>
            ) : reportPatients.map((p, i) => (
              <div key={p.patientId} className="pt-connect-card" style={{ animationDelay: `${i * .07}s` }}>
                <div className="pt-connect-hdr">
                  <div className="pt-connect-av">{p.patientName.charAt(0).toUpperCase()}</div>
                  <div style={{ flex: 1 }}>
                    <div className="pt-connect-name">{p.patientName}</div>
                    <div className="pt-connect-meta">
                      {p.patientAge}y · {p.patientGender} · Blood: {p.blood}
                      {p.phone && <> · 📞 {p.phone}</>}
                      {p.address && <> · 📍 {p.address}</>}
                    </div>
                    <div style={{ display: "flex", gap: 6, marginTop: 5, flexWrap: "wrap" }}>
                      <span className={`urg-bdg ${p.latestReport.urgency}`}>{p.latestReport.urgency === "high" ? t.urgencyHigh : p.latestReport.urgency === "medium" ? t.urgencyMed : t.urgencyLow}</span>
                      <span style={{ background: "rgba(13,92,74,.08)", color: "var(--em)", padding: "2px 9px", borderRadius: "100px", fontSize: ".65rem", fontWeight: 600 }}>{p.reportCount} Report{p.reportCount > 1 ? "s" : ""}</span>
                      <span className="on-bdg">Active Patient</span>
                    </div>
                  </div>
                </div>
                <div style={{ fontFamily: "Sora,sans-serif", fontSize: ".72rem", fontWeight: 700, color: "var(--tl)", textTransform: "uppercase", letterSpacing: ".5px", marginBottom: 6 }}>Latest AI Report Summary</div>
                <div className="pt-connect-report">{p.latestReport.content.slice(0, 400)}{p.latestReport.content.length > 400 ? "..." : ""}</div>
                <div className="pt-connect-btns">
                  <button className="con-btn" onClick={() => setModal({ type: "chat", doctor: { name: p.patientName, avatar: p.patientName.charAt(0) } })}>💬 {t.chat}</button>
                  <button className="con-btn" style={{ background: "linear-gradient(135deg,#3182ce,#2b6cb0)" }} onClick={() => setModal({ type: "call", callType: "audio", doctor: { name: p.patientName } })}>📞 Audio Call</button>
                  <button className="con-btn" style={{ background: "linear-gradient(135deg,#805ad5,#6b46c1)" }} onClick={() => setModal({ type: "call", callType: "video", doctor: { name: p.patientName } })}>📹 Video Call</button>
                  <button className="btn-s" onClick={() => showToast(`Appointment request sent to ${p.patientName}!`, "ok")}>📅 Schedule</button>
                </div>
              </div>
            ))}
          </>
            ...
            {posts.map((p, i) => (
              <div key={p.id} className="post-card" style={{ animationDelay: `${i * .05}s` }}>
                ...
                <div className="post-acts">
                  <button className="pa-btn">{p.likes} Likes</button>
                  <button className="pa-btn">{p.comments} Comments</button>
                  <button className="pa-btn">Share</button>
                </div>
              </div>
            ))}
          </>
...
function ModalRenderer({ modal, setModal, t }) {
  ...
  const send = () => {
    ...
    setTimeout(() => setMsgs(p => [...p, { from: "doctor", text: "Thank you for sharing that. Based on what you have described, I would recommend coming in for a proper examination. Please rest and stay hydrated in the meantime." }]), 1200);
  };
  if (modal.type === "call") return (
    <div className="mo" onClick={() => setModal(null)}>
      <div className="modal-box" onClick={e => e.stopPropagation()}>
        <div className="call-anim">{modal.callType === "video" ? "VIDEO" : "CALL"}</div>
        ...
        <div style={{ fontSize: ".75rem", color: "var(--tl)", margin: "0 0 20px", background: "var(--glass)", padding: "10px 13px", borderRadius: 10 }}>End-to-end encrypted real-time call</div>
        <div className="mo-btns">
          {modal.callType === "video" && <button className="btn-s">Mute</button>}
          <button className="end-btn" onClick={() => setModal(null)}>End Call</button>
        </div>
      </div>
    </div>
  );
    ...
    <div className="mo" onClick={() => setModal(null)}>
      <div className="modal-box" style={{ maxWidth: 480, padding: 0, overflow: "hidden", textAlign: "left" }} onClick={e => e.stopPropagation()}>
        <div className="ch-hdr" style={{ borderRadius: "18px 18px 0 0" }}>
          <div className="ch-av">{(modal.doctor?.name || "D").charAt(0).toUpperCase()}</div>
          <div>
            <div className="ch-name">{modal.doctor?.name}</div>
            <div className="ch-status"><span className="sdot"></span> Online</div>
          </div>
